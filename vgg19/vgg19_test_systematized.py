...
logging.basicConfig(level=logging.DEBUG,
                    ...
                    filemode = 'a',)
# start time
print ("[STATUS] ---------vgg19 test systeatized - start time - {}".format(datetime.datetime.now().strftime("%Y-%m-%d %H:%M")))
logging.info("------------ vgg19 test systeatized - start time - {}".format(datetime.datetime.now().strftime("%Y-%m-%d %H:%M")))
start = time.time()
