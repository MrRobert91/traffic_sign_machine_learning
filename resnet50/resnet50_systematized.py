...
logging.basicConfig(level=logging.DEBUG,
                    ...
                    filemode = 'a',)
# start time
print ("[STATUS] -------- resnet50 systematized - start time - {}".format(datetime.datetime.now().strftime("%Y-%m-%d %H:%M")))
logging.info(" -------- resnet50 systematized start time - {}".format(datetime.datetime.now().strftime("%Y-%m-%d %H:%M")))
start = time.time()
...
# codificamos las labels con LabelEncoder
le = LabelEncoder()
