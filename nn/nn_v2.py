...
val_accuracy = nn_classifier.evaluate(x_val, y_val, verbose=1)
...
print("loss y val accuracy :"+str(val_accuracy))
logging.info("loss y val accuracy  :"+str(val_accuracy))
