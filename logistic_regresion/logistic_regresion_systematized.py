...
logging.basicConfig(level=logging.DEBUG,
                    ...
                    filemode = 'a',)
# start time
print ("[STATUS]-------logistic_regresion systematized - start time - {}".format(datetime.datetime.now().strftime("%Y-%m-%d %H:%M")))
logging.info(" --------logistic_regresion systematized - start time - {}".format(datetime.datetime.now().strftime("%Y-%m-%d %H:%M")))
start = time.time()
